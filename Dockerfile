...
COPY app /app
RUN sed -i "s/VERSION='1.4.1'/VERSION='1.6.1'/" /app/main.py \
    ...
    && rm /app/patch_restore_v152.py /app/patch_restore_v153.py /app/patch_restore_v160.py /app/patch_restore_v161.py \
