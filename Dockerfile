...
RUN sed -i "s/VERSION='1.4.1'/VERSION='${APP_VERSION}'/" /app/main.py \
    ...
    && python /app/patch_mounts_v173.py \
    && python /app/patch_mounts_v174.py \
    && python /app/patch_archive_engine_v180.py \
    && python /app/patch_restore_v181.py \
    && python /app/patch_restore_v182.py \
    && rm /app/patch_restore_v152.py /app/patch_restore_v153.py /app/patch_restore_v160.py /app/patch_restore_v161.py /app/patch_backup_v170.py /app/patch_mounts_v171.py /app/patch_mounts_v172.py /app/patch_mounts_v173.py /app/patch_mounts_v174.py /app/patch_archive_engine_v180.py /app/patch_restore_v181.py /app/patch_restore_v182.py \
